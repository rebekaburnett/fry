...
![flow-diagram.png](https://stoplight.io/api/v1/projects/cHJqOjEzNzkyMQ/images/RWROSenwCAc "Vipps checkout flow chart")
...
![vipps-flow-web.png](https://stoplight.io/api/v1/projects/cHJqOjEzNzkyMQ/images/JWJ5Hen5rJk "Regular and express checkout")
...
![express-explicit-flow.png](https://stoplight.io/api/v1/projects/cHJqOjEzNzkyMQ/images/v0oi5rjuahE "New explicit checkout flow")
*The new explicit checkout flow ("useExplicitCheckoutFlow": true)*

![express-explicit-false.png](https://stoplight.io/api/v1/projects/cHJqOjEzNzkyMQ/images/TIZymvND9t4 "The old checkout flow")
